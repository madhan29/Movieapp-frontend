...
function Home(){
    ...
    const updateTicketStatus = (movieName,noOfTicketsAvailable,ticketStatus) => {
        ...
        if(noOfTicketsAvailable.toString() === '0'){
            axios.put(`https://moviebooking-y6k3w4hbra-uc.a.run.app/api/v1.0/moviebooking/${movieName}/update`,{},{
                headers:{
                    'Content-Type': 'application/json',
                    Authorization:`Bearer ${localStorage.getItem('accessToken')}`
                }
    ...
    const deleteMovie = (movieName) => {
        ...
        axios.delete(`https://moviebooking-y6k3w4hbra-uc.a.run.app/api/v1.0/moviebooking/${movieName}/delete`,{
            headers:{
                'Content-Type': 'application/json',
                Authorization:`Bearer ${localStorage.getItem('accessToken')}`
            }
